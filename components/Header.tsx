      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm sticky top-0 z-40 overflow-x-auto transition-colors duration-200">
        <div className="px-3 sm:px-4 md:px-6 flex items-center justify-between gap-2 sm:gap-4 border-b-2 border-brand-primary py-3">
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto flex-1">
            ...
            <a href="/products" className={isActive('/products') ? 'px-3 py-1.5 text-xs font-semibold whitespace-nowrap rounded-full transition-all duration-300 bg-green-50 text-green-700 shadow-sm' : 'px-3 py-1.5 text-xs font-medium whitespace-nowrap rounded-full transition-all duration-300 text-gray-600 hover:text-gray-900 hover:bg-gray-100'}>Products</a>
            <a href="/stock-movements" className={isActive('/stock-movements') ? 'px-3 py-1.5 text-xs font-semibold whitespace-nowrap rounded-full transition-all duration-300 bg-purple-50 text-purple-700 shadow-sm' : 'px-3 py-1.5 text-xs font-medium whitespace-nowrap rounded-full transition-all duration-300 text-gray-600 hover:text-gray-900 hover:bg-gray-100'}>Stock Movements</a>
            <a href="/suppliers" className={isActive('/suppliers') ? 'px-3 py-1.5 text-xs font-semibold whitespace-nowrap rounded-full transition-all duration-300 bg-orange-50 text-orange-700 shadow-sm' : 'px-3 py-1.5 text-xs font-medium whitespace-nowrap rounded-full transition-all duration-300 text-gray-600 hover:text-gray-900 hover:bg-gray-100'}>Suppliers</a>
            <a href="/reports" className={isActive('/reports') ? 'px-3 py-1.5 text-xs font-semibold whitespace-nowrap rounded-full transition-all duration-300 bg-amber-50 text-amber-700 shadow-sm' : 'px-3 py-1.5 text-xs font-medium whitespace-nowrap rounded-full transition-all duration-300 text-gray-600 hover:text-gray-900 hover:bg-gray-100'}>Reports</a>
            <a href="/stocktake" className={isActive('/stocktake') ? 'px-3 py-1.5 text-xs font-semibold whitespace-nowrap rounded-full transition-all duration-300 bg-rose-50 text-rose-700 shadow-sm' : 'px-3 py-1.5 text-xs font-medium whitespace-nowrap rounded-full transition-all duration-300 text-gray-600 hover:text-gray-900 hover:bg-gray-100'}>Stocktake</a>
          </div>
