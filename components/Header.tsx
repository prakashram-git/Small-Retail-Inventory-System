  ...
  return (
    <>
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm sticky top-0 z-40 transition-colors duration-200">
        ...
        <div className="px-3 sm:px-4 md:px-6 py-3 border-t border-gray-200 dark:border-gray-700 overflow-x-auto">
          <div className="flex gap-2 min-w-max">
            ...
            <a href="/master-products" className={isActive('/master-products') ? 'px-3 py-2 text-xs font-semibold whitespace-nowrap rounded-2xl transition-all duration-300 bg-indigo-100 text-indigo-700 shadow-sm dark:bg-indigo-900 dark:text-indigo-200' : 'px-3 py-2 text-xs font-medium whitespace-nowrap rounded-2xl transition-all duration-300 bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600'}>Master</a>
